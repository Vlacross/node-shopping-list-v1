...
Recipes.create('TomatoeSauce', ['tomatoes', 'basil', 'olive oil']);
Recipes.create('eggs', ['eggs']);
Recipes.create('chipshire spooners', ['fatigue', 'forest ground caps', 'eleven elven entrepreneurs'])
